...
privileged aspect MensajeController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> MensajeController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
        ...
        try {
            ...
            headers.add("Location",uriBuilder.path(a.value()[0]+"/"+mensaje.getId().toString()).build().toUriString());
